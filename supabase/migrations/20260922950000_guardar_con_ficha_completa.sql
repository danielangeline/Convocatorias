-- guardar_convocatoria vuelve a exigir la ficha completa a una publicada
-- (RN-01, RF-09, CU-05 · sesión 016, por decisión del Product Owner).
--
-- La sesión 015 la había retirado (migración 20260922900006) creyendo que
-- llamar a privado.ficha_publicable desde aquí colgaba el guardado ~20 s. No
-- era así: el cuelgue lo causa la red de la máquina de desarrollo, que pierde
-- ciertas peticiones según su tamaño exacto en bytes
-- (docs/incidentes/2026-09-22-cuelgue-al-guardar-convocatoria.md, §9).
--
-- Es el mismo cuerpo de 20260922900004: el de la sesión 011 más la
-- comprobación final. Cierra el hueco de poder quitarle ubicación,
-- descripción o categoría a una publicada editándola. Quitar un adjunto va por
-- otro camino (DELETE sobre documentos_convocatoria) y sigue sin protegerse.
