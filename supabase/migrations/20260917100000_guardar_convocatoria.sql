-- =============================================================================
-- Guardar una convocatoria desde el panel (sesión 011)
-- docs/05-modelo-de-datos.md §9.13 · RF-05, RF-06, RF-08, RN-01, RN-04, RNF-29
--
-- Datos, categorías y requisitos en una sola transacción. security invoker: la
-- RLS del catálogo (administrador vigente con aal2) sigue aplicando; la
-- comprobación de entrada solo da un rechazo legible.
-- No cambia el estado: publicar y despublicar tienen su propio endpoint (RF-09).
-- =============================================================================
...
begin
  ...
  -- RN-01: una publicada no queda sin enlace oficial ni sin requisitos.
