...
| ID | Regla |
|---|---|
| RN-01 | Una convocatoria es visible solo cuando el admin completa **la ficha entera** y publica. Publicar exige: nombre, entidad convocante, **ubicación o cobertura**, **descripción u objeto**, fecha de cierre no vencida, **enlace oficial de postulación**, **al menos una categoría**, **al menos un documento adjunto** y **al menos dos requisitos** *(ampliado en v5; lista fijada en v6, sesión 015, por decisión del Product Owner tras recorrer el panel)*. **Historia de los adjuntos:** v5 los exigía, la sesión 012 los hizo opcionales —por si una entidad anuncia antes de colgar los términos— y la 015 los vuelve a exigir: una ficha sin documentos deja a la empresa sin qué leer y a la generación con IA sin el texto del TDR. Ubicación, categorías y montos son además los filtros del catálogo (RF-12): sin ellos la convocatoria no aparece cuando alguien filtra. **Una publicada no puede quedar incompleta:** editarla o quitarle adjuntos se rechaza si deja de cumplir la lista; para quitar algo, primero se despublica *(sesión 016: comprobación completa al guardar restaurada y último adjunto protegido)* |
