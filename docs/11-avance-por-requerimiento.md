...
| RF-07 Adjuntar documentos | prototipo | Sin Storage real. Sesión 011: el editor del panel ya no simula adjuntos; muestra cuántos hay en la base (0) y avisa que la carga llega después (Sprint 2, paso 2) |
...
| RF-09 Publicar validado | pendiente | Sesión 011: el editor conectado a Supabase ya no publica (botón deshabilitado hasta el endpoint `.../publicar`, Sprint 2 paso 3). Antes publicaba solo en el store |
